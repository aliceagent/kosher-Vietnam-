            ...
            <li key={item.href}>
              <Link
                ...
                className={`flex min-h-14 flex-col items-center justify-center gap-0.5 text-[11px] font-semibold ${
                  active ? "text-lacquer" : "text-stone"
                }`}
              >
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        ...
        strokeWidth="1.7"
      />
      <circle cx="12" cy="10" r="2.2" stroke={active ? "#9a1f2a" : "#2a3f38"} strokeWidth="1.7" />
    </svg>
  );
}
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        ...
        strokeWidth="1.7"
      />
      <path d="M8 7c.5 2 2 3 4 3s3.5-1 4-3" stroke={active ? "#9a1f2a" : "#2a3f38"} strokeWidth="1.7" />
    </svg>
  );
}
...
function RouteIcon({ active }: { active: boolean }) {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      <circle cx="7" cy="7" r="2.2" stroke={active ? "#9a1f2a" : "#2a3f38"} strokeWidth="1.7" />
      <circle cx="17" cy="17" r="2.2" stroke={active ? "#9a1f2a" : "#2a3f38"} strokeWidth="1.7" />
      <path d="M9 8c4 0 4 8 8 8" stroke={active ? "#9a1f2a" : "#2a3f38"} strokeWidth="1.7" />
    </svg>
  );
}
